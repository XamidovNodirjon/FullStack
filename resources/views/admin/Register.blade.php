                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <ul class="list-inline">
                                            <li class="list-inline-item">
                                                <a href="javascript:void(webkitRequestAnimationFrame)" class="social-list-item bg-primary text-white border-primary">
                                                    <i class="mdi mdi-facebook"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript:void(addEventListener(webkitRequestAnimationFrame))" class="social-list-item bg-info text-white border-info">
                                                    <i class="mdi mdi-twitter"></i>
                                                </a>
                                            </li>
                                            <li class="list-inline-item">
                                                <a href="javascript:void(statesData)" class="social-list-item bg-danger text-white border-danger">
