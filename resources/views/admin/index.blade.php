            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle text-reset" href="{{route('admin.index')}}" id="dropdownMenuButton5"
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton5">
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Monthly</a>
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Yearly</a>
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Weekly</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle text-reset" href="{{route('admin.index')}}" id="dropdownMenuButton1"
                                   data-bs-toggle="dropdown" aria-haspopup="true"
                                   aria-expanded="false">
                                    <span class="fw-semibold">Sort By:</span> <span class="text-muted">Yearly<i class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class=" dropdown-toggle" href="{{route('admin.index')}}" id="dropdownMenuButton2"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="text-muted">All Members<i class="mdi mdi-chevron-down ms-1"></i></span>
                                </a>

                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton2">
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Locations</a>
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Revenue</a>
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Join Date</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="{{route('admin.index')}}" id="dropdownMenuButton3"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton3">
                                    <a class="dropdown-item" href="{{route('admin.index')}}">Recent</a>
                                    <a class="dropdown-item" href="{{route('admin.index')}}">By Users</a>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-xl-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="float-end">
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="{{route('admin.index')}}" id="dropdownMenuButton4"
                                   data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="text-center">
                            ...
                            <h5><a href="{{route('admin.index')}}" class="text-dark">Facebook - <span class="text-muted font-16">125 sales</span> </a></h5>
                            ...
                            <a href="{{route('admin.index')}}" class="text-reset font-16">Learn more <i class="mdi mdi-chevron-right"></i></a>
                        </div>
                        <div class="row mt-4">
                            <div class="col-4">
                        ...
                        <div class="mt-3 text-center">
                            <a href="{{route('admin.index')}}" class="text-primary font-size-14 fw-medium">View All Sources <i class="mdi mdi-chevron-right"></i></a>
                        </div>
